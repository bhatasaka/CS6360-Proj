...
public class AsynchronousClient
{
    ...
    private const int defaultPort = 5360;
    private const string defaultIP = "172.26.67.37";
    ...
    public AsynchronousClient(int port = defaultPort, string IP = defaultIP)
    {
        this.port = port;
        this.IP = IP;
    ...
    public void StartClient()
    {
        ...
        try
        {
            ...
            //Debug.Log("Response received : {0}", response);
